...
class Ffb(MakefilePackage):
    ...
    version('9.0', sha256='dd107782173831e34a037c6fa51c2ae2855f0c74eb67188148f7b8049487ae32',
                   url="file://{0}/FFB.ver.9.0_202210.r3.tar.gz".format(os.getcwd()))
    ...
    def edit(self, spec, prefix):
        ...
        if spec.satisfies('@8.1'):
            ...
            m.filter(r'module load lang/tcsds-1.2.41', '')
