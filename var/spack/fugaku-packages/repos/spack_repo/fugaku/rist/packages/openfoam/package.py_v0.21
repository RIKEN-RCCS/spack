...
class Openfoam(Package):
    ...
    url = "https://sourceforge.net/projects/openfoam/files/v2406/OpenFOAM-v2406.tgz"
...
#   )
    ...
    depends_on("mgard@2023-03-31", when="@2406:")
    ...
    patch('2006_fj_c++14.patch', when='@2006%fj')
    patch('2012_fj_c++14.patch', when='@2012%fj')
    patch('2106_fj_c++14.patch', when='@2106%fj')
    patch('2112_fj.patch', when='@2112%fj', level=2)
    patch('2206_fj.patch', when='@2206%fj', level=2)
    patch('2212_fj.patch', when='@2212%fj', level=2)
    patch('2012_gcc.patch', when='@2012%gcc', level=2)
    patch('2106_gcc.patch', when='@2106%gcc', level=2)
    patch('2112_gcc.patch', when='@2112%gcc', level=2)
    patch('2206_gcc.patch', when='@2206%gcc', level=2)
    patch('2212_gcc.patch', when='@2212%gcc', level=2)
    patch('2306_gcc.patch', when='@2306%gcc', level=2)
    # kahip patch (wmake)
    patch(
