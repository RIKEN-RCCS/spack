...
class Lammps(CMakePackage, CudaPackage, ROCmPackage, PythonExtension):
    ...
    patch("rist-29Oct2020.patch", when="@20201029 +fj_loopopt %fj")
    patch("rist-23Jun2022.patch", when="@20220623 +fj_loopopt %fj")   ### this patch does not contain the result for tersoff tuning
    patch("rist-02Aug2023.patch", when="@20230802 +fj_loopopt %fj")
    patch("rist-29Aug2024.patch", when="@20240829 +fj_loopopt %fj")
    patch("rist-22Jul2025.patch", when="@20250722 +fj_loopopt %fj")

    # patch("rist-29Oct2020-fjbugfix-20230329.patch", when='@20201029 +user-ptm %fj')
    patch("rist-29Oct2020-fjbugfix-20230329.patch", when='@20201029 +user-ptm %fj@:4.8.1')
    patch("rist-23Jun2022-fjbugfix.patch", when='@20220623: +ptm %fj@:4.8.1')
    # patch("rist-02Aug2023-fjbugfix.patch", when='@20230802:+ptm  %fj@:4.8.1')
    # patch("rist-29Aug2024-fjbugfix.patch", when='@20240829 +ptm %fj@:4.8.1')

    patch("rist-29Oct2020-exceptions.patch", when='@20201029 +exceptions %fj')
    patch("rist-23Jun2022-exceptions.patch", when='@20220623 +exceptions %fj')
    patch("rist-02Aug2023-exceptions.patch", when='@20230802:20230802.1 +exceptions %fj')
    patch("rist-02Aug2023-exceptions.patch", when='@20230802.2:20230802.4 %fj')
    patch("rist-29Aug2024-fugaku.patch", when='@20240829:20240829.3 %fj')
    ### [RIST] added part ###
