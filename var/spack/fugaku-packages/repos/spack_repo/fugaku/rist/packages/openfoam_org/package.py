...
class OpenfoamOrg(Package):
    ...
    patch('8_fj_new.patch', when='@8%fj', level=2)
    patch('9_fj.patch', when='@9%fj', level=2)
    patch('10_fj.patch', when='@10%fj', level=2)
    patch('11_fj.patch', when='@11%fj', level=2)
    patch('12_fj.patch', when='@12%fj', level=2)
