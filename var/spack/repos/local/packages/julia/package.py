...
class Julia(MakefilePackage):
    ...
    def edit(self, spec, prefix):
        ...
        if julia_cpu_target == "neoverse_v1":
           julia_cpu_target = 'neoverse-v1'
        ...
        options.extend(
            [
                ...
                "override SHIPFLAGS_COMMON:={0}".format("-O3 -Wno-incompatible-pointer-types" if "%gcc@14.1.0" in spec else "-O3")
            ]
        )
