...
#    url      = "https://github.com/phonopy/phonopy/archive/refs/tags/v2.12.0.tar.gz"
    ...
    #version("2.27.0", branch="master")
    #version('2.27.0', sha256='af712adc484a32bae031e5a2754f5ffc89fb61e616eab08864f2a6f4454d81cc')
    ...
    depends_on('py-setuptools', type=('build'), when='@2.26.0:')
