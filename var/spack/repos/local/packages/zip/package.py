...
class Zip(MakefilePackage):
    ...
    def build(self, spec, prefix):
        ...
        if "%gcc@14.1.0" in spec:
            make("-f", "unix/Makefile", "CC=" + spack_cc + " -Wno-implicit-function-declaration -Wno-incompatible-pointer-types -Wno-int-conversion" , "generic")
        else:
...
#        spec = self.spec
#        if "%gcc@14.1.0" in spec:
#            env.append_flags("CFLAGS", "-Wno-implicit-function-declaration -Wno-incompatible-pointer-types -Wno-int-conversion")
